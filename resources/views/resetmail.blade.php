                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Reset Link</h1>
                                    </div>
                                        <div class="form-group">
                                            <p>Click the below button and Reset your password.</p>
                                            {{-- {{$user}} --}}
                                            <div class="form-group mb-0"> <a class="btn btn-primary btn-block" href="{{ Route('reset_password',[$user])}}">Reset Password Link </a></div>
                                            </div>
